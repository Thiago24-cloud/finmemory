...
const ENV_VARS = {
  ...
  GOOGLE_REDIRECT_URI: {
    ...
    example: 'https://finmemory.vercel.app/api/auth/callback'
  },
 ...
 */
function validateEnvGroup(varNames) {
  const results = [];
  let allValid = true;
 ...
 */
function createValidationMiddleware(requiredVars) {
...
// ES6 exports (para Next.js API routes)
export {
  ENV_VARS,
  validateEnvVar,
  validateEnvGroup,
...
// CommonJS exports (para scripts Node.js)
// Suporte para ambientes que usam require()
