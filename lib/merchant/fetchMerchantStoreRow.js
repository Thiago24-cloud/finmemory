const STORE_SELECT_FULL =
  'id, name, address, lat, lng, active, needs_review, type, owner_user_id, tempo_preparo_medio, cnpj';
const STORE_SELECT_MID = 'id, name, address, lat, lng, active, needs_review, type, owner_user_id, cnpj';
