/** Runtime (JS) — tipos em characterSpeeches.ts */

export const CHARACTER_SPEECHES = {
...
/** @param {keyof typeof CHARACTER_SPEECHES} state */
export function pickRandomSpeech(state) {
