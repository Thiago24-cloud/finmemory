...
export const ENV_VARS = {
  ...
  GOOGLE_REDIRECT_URI: {
    ...
    // 'http://localhost:3000/api/auth/callback/google,https://www.finmemory.com.br/api/auth/callback/google,https://finmemory.com.br/api/auth/callback/google'
    required: true,
    public: false,
    description: 'URI de redirecionamento OAuth',
    example: 'https://finmemory.vercel.app/api/auth/callback/google'
  },
