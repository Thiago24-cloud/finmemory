...
import { accountTypeToUserRole, USER_ROLE_RETAILER } from '../../../lib/userType';
...
export default async function handler(req, res) {
  ...
  const isRetailer =
    accountTypeToUserRole(userRow?.account_type) === USER_ROLE_RETAILER ||
    accountTypeToUserRole(session?.user?.account_type) === USER_ROLE_RETAILER;
