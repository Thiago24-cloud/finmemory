const STORE_SELECT_FULL =
  'id, name, address, lat, lng, active, needs_review, type, owner_user_id, tempo_preparo_medio, cnpj, codigo_equipe, stripe_connect_account_id, stripe_connect_charges_enabled, stripe_connect_payouts_enabled, stripe_connect_onboarded_at';
const STORE_SELECT_MID =
  'id, name, address, lat, lng, active, needs_review, type, owner_user_id, cnpj, codigo_equipe, stripe_connect_account_id, stripe_connect_charges_enabled, stripe_connect_payouts_enabled';
