...
export function MerchantProductForm({ onSaved, onCancel }) {
  ...
  return (
    <form onSubmit={onSubmit} className="mt-6 rounded-2xl border border-border bg-card p-6 space-y-4 shadow-subtle">
      <h2 className="text-lg font-bold m-0 text-foreground">Novo item</h2>
      ...
      <div className="flex flex-col sm:flex-row gap-4">
        <button
          ...
          disabled={uploading}
          className="relative shrink-0 w-full sm:w-32 h-32 rounded-2xl border-2 border-dashed border-border bg-white flex flex-col items-center justify-center gap-2 hover:border-primary/50 transition-colors overflow-hidden p-2"
        >
          {form.image_url ? (
      ...
      <label className="flex items-start gap-3 rounded-xl border border-primary/30 bg-primary/10 p-4 cursor-pointer">
        <input
          type="checkbox"
      ...
      <div className="flex flex-col sm:flex-row gap-2">
        <button
          ...
          className="flex-1 flex items-center justify-center gap-2 rounded-xl bg-primary py-3 font-bold text-primary-foreground disabled:opacity-60"
        >
