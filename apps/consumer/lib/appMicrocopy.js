...
export const DASHBOARD = {
  ...
  /** Rótulo do carrossel de meses no dashboard */
  monthCarouselLabel: 'Período',
...
export const BOTTOM_NAV = {
  ...
  /** Tooltip do FAB central — hierarquia: NF-e é a ação principal; código de barras fica no mapa/atalhos contextuais */
  scanFabTitle: 'Escanear nota fiscal (NF-e)',
};
