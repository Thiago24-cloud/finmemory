-- Várias lojas por conta + mesmo CPF/CNPJ em filiais (confirmação única por usuário).

-- Remover 1 perfil por usuário e 1 documento global
...
-- Confirmação única quando o usuário reutiliza CPF/CNPJ já existente na plataforma
