-- Sprint 1 Parceiros: insumos (matéria-prima) separados de produtos_loja (ofertas).
...
-- Movimentações (entrada NF, saída, ajuste) — usado a partir do Sprint 2.
...
-- Notas de entrada (Sprint 2 — schema antecipado).
...
-- FK movimentação → nota (após tabela existir).
DO $$
BEGIN
  IF NOT EXISTS (
