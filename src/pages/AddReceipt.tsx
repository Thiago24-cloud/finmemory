      ...
      <main className="max-w-2xl mx-auto px-4 py-6">
        ...
        {step === "preview" && imagePreview && (
          <div className="bg-card rounded-2xl card-shadow p-6 animate-fade-in space-y-4">
            ...
            <div className="flex gap-3">
              <Button
                className="flex-1 gradient-primary text-primary-foreground font-semibold py-5 rounded-xl"
              ...
              <Button
                variant="outline"
                className="flex-1 border-primary text-primary py-5 rounded-xl"
                onClick={() => {
        ...
        {step === "processing" && (
          <div className="bg-card rounded-2xl card-shadow p-12 text-center animate-fade-in">
            ...
            <p className="text-muted-foreground text-sm">
              Nossa IA está extraindo os dados da imagem
            </p>
          ...
          <div className="bg-card rounded-2xl card-shadow p-6 animate-fade-in space-y-4">
            ...
            <div className="space-y-3">
              ...
              <div>
                ...
                >
                  {["Alimentação", "Saúde", "Transporte", "Lazer", "Educação", "Outros"].map((c) => (
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full rounded-lg border border-input bg-background px-3 py-2 text-sm"
                >
                  {["Cartão de Crédito", "Cartão de Débito", "PIX", "Dinheiro"].map((p) => (
            ...
            <Button
              className="w-full gradient-primary text-primary-foreground font-semibold py-5 rounded-xl mt-2"
              onClick={handleSave}
            >
              ✅ Salvar Nota Fiscal
            </Button>
