  ...
  const items = [
    {
      ...
      label: 'Mapa',
      Icon: Map,
      tile: 'bg-gradient-to-br from-sky-950/80 to-[#0f172a] border-sky-500/30 text-sky-300',
    ...
    },
    {
      ...
      label: 'Escanear',
      Icon: ScanLine,
      tile: 'bg-gradient-to-br from-emerald-950/90 to-[#0f172a] border-emerald-500/40 text-emerald-300',
    ...
    },
    {
      ...
      label: 'Extrato',
      Icon: History,
      tile: 'bg-gradient-to-br from-violet-950/80 to-[#0f172a] border-violet-500/30 text-violet-300',
    ...
    },
    {
      ...
      label: 'Missões',
      Icon: Swords,
      tile: 'bg-gradient-to-br from-amber-950/70 to-[#0f172a] border-amber-500/35 text-amber-300',
    ...
    },
    {
      ...
      label: 'Simulador',
      Icon: Sparkles,
      tile: 'bg-gradient-to-br from-purple-950/80 to-[#0f172a] border-purple-500/30 text-purple-300',
    ...
    },
    {
      ...
      label: 'Lista',
      Icon: List,
      tile: 'bg-gradient-to-br from-emerald-950/60 to-[#0f172a] border-emerald-500/25 text-emerald-300',
